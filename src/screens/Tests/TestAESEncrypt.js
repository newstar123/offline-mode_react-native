...
class TestAESEncrypt extends Component {
    ...
    testHandler = () => {
        ...
        // encryption
        let encrypted = AES256.encrypt('TEXT', 'PASSWORD');
        console.log("------> encrypted: ", encrypted);

        let decrypt2 = AES256.decrypt('U2FsdGVkX1/rjzH6E1fh9sY0iisNN9vZF6Ev/skxVFi84+yYEe/6/GmNsN3Kyv0b9FjfhF43hYEebbh0C/qS7g==', '51655468576D5A7134743777217A2543');
        console.log("------> decrypt2: ", decrypt2);

        // decryption
        console.log("------> decrypt: ", AES256.decrypt(encrypted, 'PASSWORD'));
    };
                ...
                <View style={{marginTop: 100,}}>
                    ...
                    <View>
                        ...
                        <TouchableOpacity onPress={this.testEverywhere}>
                            <View>
                                <Text sytle={{fontSize: 30}}>testEverywhere</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={this.testAES}>
                            <View>
                                <Text sytle={{fontSize: 30}}>testAES</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
...
export default withApollo(TestAESEncrypt);
